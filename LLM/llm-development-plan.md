...
- Ollama model storage target: `%LOCALAPPDATA%\ollama\models`
- Voice2Text LLM logs target: `%LOCALAPPDATA%\ollama\logs`
...
- `gemma4:e2b` and `gemma4:e4b` are pulled into `%LOCALAPPDATA%\ollama\models`.
...
4. Set `OLLAMA_MODELS` to `%LOCALAPPDATA%\ollama\models`.
...
- Do not place Ollama models or logs under OneDrive or the Voice2Text app folder. Keep Ollama assets in `%LOCALAPPDATA%\ollama\...`.
